...
class MainWindow:
    ...
    def parse_config(self, path=None):
        ...
        if self.server.group_num > 1:
            showwarning(title="New Group", message="The config file you loaded is for group {}. Please check with your PI if you're ready to proceed.".format(self.server.group_num))
